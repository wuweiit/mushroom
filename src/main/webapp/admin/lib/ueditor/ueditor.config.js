...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , serverUrl:  　"/admin/upload.do"
        // ,imageUrlPrefix: BASEURL
        ,imageUrlPrefix: ''
        ...
        , toolbars: [[
            ...
            'insertimage', 'emotion', 'scrawl', 'insertvideo', 'attachment', 'map',  'insertframe', 'insertcode',  'pagebreak', 'template', 'background', '|',
